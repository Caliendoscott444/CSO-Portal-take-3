    ...
    <section id="divisions" className="relative py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <SectionHeader
          ...
          title="Three divisions, total coverage"
          subtitle="The Comet Strategic Operations Corporation operates through three elite divisions, each with distinct capabilities and specialized units."
        />
