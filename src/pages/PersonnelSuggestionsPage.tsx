...
export default function PersonnelSuggestionsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await supabase.from('personnel_suggestions').insert({
  ...
  return (
    <>
      <PageHero
        ...
        title="Personnel Suggestions"
        subtitle={`Have feedback about personnel or staffing at ${ORG_ABBR}? Submit it here and it goes straight to our staff team's Discord.`}
      />
          ...
          >
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                placeholder="What would you like to see improved regarding personnel?"
                rows={6}
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-3.5 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:border-amber-500/50 focus:outline-none"
              />
            </div>
